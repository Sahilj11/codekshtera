...
export function GlobeDemo() {
  ...
  return (
  <div className="flex flex-col items-center justify-center py-10 h-auto md:h-screen bg-black text-white w-screen overflow-x-hidden">
  <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-auto md:h-[40rem] px-4 flex flex-col items-center">
    ...
    >
      <h2 className="text-xl md:text-4xl font-semibold text-zinc-200">
    ...
    {/* Globe Section */}
    <div className="w-full max-w-4xl h-72 md:h-[400px] relative flex items-center justify-center mt-6 md:mt-0">
